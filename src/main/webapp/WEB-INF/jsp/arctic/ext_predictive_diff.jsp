...
<body id="fabulousbdtc">
            ...
            <div class="row form-horizontal">
                ...
                <div class="vcenter">
                    <div class="pull-left" style="margin-right: 15px;">
                        <button  type="button" class="meBtn meBtn-primary meBtn-lg outline" style="margin-top:2px;" id="btn_getMostRecentOne"><spring:message code="button.latest.stuff"/></button>
                    </div>
                    ...
                    <div id="retrievalRangeSelector" class="dropdown select pull-left" style="margin-left: 3px;margin-right: 3px">
                        <button class="  btn-small dropdown-toggle " type="button" id="menu1" data-toggle="dropdown" style="margin-top:6px;">
                            <c:if test="${interval eq 'MONTH'}"><span class="selected" id="2" value="MONTH"><spring:message code="dropdown.seeking.interval.monthly"/></span><span class="caret"></span></c:if>
                            <c:if test="${interval eq 'YEAR'}"><span class="selected" id="3" value="YEAR"><spring:message code="dropdown.seeking.interval.annually"/></span><span class="caret"></span></c:if>
                        </button>
                        <ul class="dropdown-menu option" role="menu" >
                            <li id="2" role="presentation" value="MONTH"><a role="menuitem" tabindex="-1" href="#"><spring:message code="dropdown.seeking.interval.monthly"/></a></li>
                            <li id="3" role="presentation" value="YEAR"><a role="menuitem" tabindex="-1" href="#"><spring:message code="dropdown.seeking.interval.annually"/></a></li>
                        </ul>
                    </div>
                ...
                <div class="pull-right" style="padding-right:50px;"> 
                    <ul id="breadcrumbs-one" class="pull-right vcenter" >
                        ...
                        <li><a><spring:message code="nav.prediction.fcst.verification"/></a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container" >
        <div class="col-lg-12">
            <h2 class="page-header" style="color: #0b56a8;"><spring:message code="fcst.fcst_verification.title"/></h2>
        </div>
        <div align="center">
            <div class="row">
                <div class="col-lg-12">
                    <button class="btn btn-primary pull-right" onclick="showTimeSeries()"><spring:message code="fcst.fcst_verification.timeseries"/></button>
                </div>
            </div>
            <table class="table table-striped" style="margin-top: 10px;">
                ...
                <thead>
                <tr class="info">
                    <th>&nbsp;</th><th><spring:message code="fcst.fcst_verification.fcst"/></th><th><spring:message code="fcst.fcst_verification.obs"/></th><th><spring:message code="fcst.fcst_verification.diff"/></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <th class="line-head"><spring:message code="fcst.fcst_verification.month1"/></th>
                ...
                <tr>
                    <th class="line-head"><spring:message code="fcst.fcst_verification.month2"/></th>
                ...
                <tr>
                    <th class="line-head"><spring:message code="fcst.fcst_verification.month3"/></th>
                ...
                <tr>
                    <th class="line-head"><spring:message code="fcst.fcst_verification.month4"/></th>
    ...
    <div id="modalDialogTs" class="modal popup fade" tabindex="-1" style="display: none;">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title"><spring:message code="fcst.fcst_verification.timeseries"/></h4>
        </div>
