...
<body id="fabulousbdtc">
            ...
            <div class="row form-horizontal">
                <div class="pull-right" style="padding-right:50px;"> 
                    <ul id="breadcrumbs-one" class="pull-right vcenter" >
                        ...
                        <li><a><spring:message code="nav.prediction"/></a></li>
                        <li><a><spring:message code="nav.prediction.seasonal.prediction"/></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container" >
        <div class="col-lg-12">
            <h3 class="page-header"><spring:message code="fcst.seasonal_prediction.title"/></h3>
        </div>
        <div align="center">
            <table>
                <tr>
                    ...
                    <td>
                        <div id="controls">
                            <div class="input-group" data-toggle="buttons"><!-- 달력 -->
                                ...
                                &nbsp;<button class="btn btn-primary btn-sm" id="btn-search" onclick="search()"><spring:message code="fcst.seasonal_prediction.btn.retrieve"/></button>
                                &nbsp;<button type="button" class="meBtn meBtn-primary meBtn-lg outline" onclick="searchRecentDate()"><spring:message code="fcst.seasonal_prediction.btn.latest"/></button>
                            </div>
                            
                            <p style="margin-bottom: 4px;margin-top: 10px;font-weight: bold;font-size: 15px;"><spring:message code="fcst.seasonal_prediction.vars"/></p>
                            <div class="btn-group" data-toggle="buttons" style="width: 100%;">
                                <label class="btn btn-info btn-sm btn-variableType btn-variableType-mslp active" id="label-variableType-mslp" style="width: 18%;">
                                    <input type="checkbox" id="variableType-mslp" name="variableType" value="mslp" checked="checked"><spring:message code="fcst.seasonal_prediction.vars.ssp"/>
                                </label>
                                <label class="btn btn-info btn-sm btn-variableType btn-variableType-t15m active" id="label-variableType-t15m" style="width: 32%;">
                                    <input type="checkbox" id="variableType-t15m" name="variableType" value="t15m" checked="checked"><spring:message code="fcst.seasonal_prediction.vars.tmp.m15"/>
                                </label>
                                <label class="btn btn-info btn-sm btn-variableType btn-variableType-tsfc active" id="label-variableType-tsfc" style="width: 34%;">
                                    <input type="checkbox" id="variableType-tsfc" name="variableType" value="tsfc" checked="checked"><spring:message code="fcst.seasonal_prediction.vars.tmp.ground"/>
                                </label>
                                <label class="btn btn-info btn-sm btn-variableType btn-variableType-wind active" id="label-variableType-wind" style="width: 16%;">
                                    <input type="checkbox" id="variableType-wind" name="variableType" value="wind" checked="checked"><spring:message code="fcst.seasonal_prediction.vars.wind"/>
                                </label>
                            </div>
                            
                            <div class="btn-group" data-toggle="buttons" style="width: 100%;margin-top: 10px;">
                                <div class="colorBarArea colorBar-mslp">
                                    <p style="margin: 0;"><spring:message code="fcst.seasonal_prediction.vars.ssp.unit"/></p>
                                ...
                                <div class="colorBarArea colorBar-t15m colorBar-tsfc">
                                    <p style="margin: 0;"><spring:message code="fcst.seasonal_prediction.vars.tmp.unit"/></p>
                                ...
                                <div class="colorBarArea colorBar-wind">
                                    <p style="margin: 0;"><spring:message code="fcst.seasonal_prediction.vars.wind.unit"/></p>
                            ...
                            <p style="margin-bottom: 4px;margin-top: 20px;font-weight: bold;font-size: 15px;"><spring:message code="fcst.seasonal_prediction.vars.month"/></p>
                            ...
                            <p style="margin-bottom: 4px;margin-top: 30px;font-weight: bold;font-size: 15px;"><spring:message code="fcst.seasonal_prediction.vars.oceans"/></p>
                            <div class="btn-group" data-toggle="buttons" style="width: 100%;"><!-- 해역 버튼 -->
                                <label class="btn btn-warning btn-sm btn-seaAreaType" id="label-seaAreaType-BRNT" style="width: 70%;"><spring:message code="fcst.seasonal_prediction.vars.oceans.barents"/></label>
                                <label class="btn btn-success btn-sm btn-seaAreaTs" onclick="showTimeSeries('BRNT', '<spring:message code="fcst.seasonal_prediction.vars.oceans.barents"/>')" style="width: 30%;"><spring:message code="fcst.fcst_verification.timeseries"/></label>
                                <br/><br/>
                                <label class="btn btn-warning btn-sm btn-seaAreaType" id="label-seaAreaType-KARA" style="width: 70%;"><spring:message code="fcst.seasonal_prediction.vars.oceans.kara"/></label>
                                <label class="btn btn-success btn-sm btn-seaAreaTs" onclick="showTimeSeries('KARA', '<spring:message code="fcst.seasonal_prediction.vars.oceans.kara"/>')" style="width: 30%;"><spring:message code="fcst.fcst_verification.timeseries"/></label>
                                <br/><br/>
                                <label class="btn btn-warning btn-sm btn-seaAreaType" id="label-seaAreaType-LPTV" style="width: 70%;"><spring:message code="fcst.seasonal_prediction.vars.oceans.laptev"/></label>
                                <label class="btn btn-success btn-sm btn-seaAreaTs" onclick="showTimeSeries('LPTV', '<spring:message code="fcst.seasonal_prediction.vars.oceans.laptev"/>')" style="width: 30%;"><spring:message code="fcst.fcst_verification.timeseries"/></label>
                                <br/><br/>
                                <label class="btn btn-warning btn-sm btn-seaAreaType" id="label-seaAreaType-ESBR" style="width: 70%;"><spring:message code="fcst.seasonal_prediction.vars.oceans.siberian"/></label>
                                <label class="btn btn-success btn-sm btn-seaAreaTs" onclick="showTimeSeries('ESBR', '<spring:message code="fcst.seasonal_prediction.vars.oceans.siberian"/>')" style="width: 30%;"><spring:message code="fcst.fcst_verification.timeseries"/></label>
                                <br/><br/>
                                <label class="btn btn-warning btn-sm btn-seaAreaType" id="label-seaAreaType-CHKC" style="width: 70%;"><spring:message code="fcst.seasonal_prediction.vars.oceans.chukchi"/></label>
                                <label class="btn btn-success btn-sm btn-seaAreaTs" onclick="showTimeSeries('CHKC', '<spring:message code="fcst.seasonal_prediction.vars.oceans.chukchi"/>')" style="width: 30%;"><spring:message code="fcst.fcst_verification.timeseries"/></label>
                                <br/><br/>
                                <label class="btn btn-warning btn-sm btn-seaAreaType" id="label-seaAreaType-BRNG" style="width: 70%;"><spring:message code="fcst.seasonal_prediction.vars.oceans.bering"/></label>
                                <label class="btn btn-success btn-sm btn-seaAreaTs" onclick="showTimeSeries('BRNG', '<spring:message code="fcst.seasonal_prediction.vars.oceans.bering"/>')" style="width: 30%;"><spring:message code="fcst.fcst_verification.timeseries"/></label>
                            </div>
                        </div>
                    </td>
                </tr>
    ...
    <div id="modalDialogTs" class="modal popup fade" tabindex="-1" style="display: none;">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><span id="modalDialogTs-title"></span> <spring:message code="fcst.fcst_verification.timeseries"/></h4>
        </div>
        <div class="modal-body">
            <div class="buttons" style="text-align: center;">
                <button class="btn btn-info btn-sm btn-modal-seaAreaTs" id="btn-modal-seaAreaTs-mslp" onclick="changeTimeSeries('mslp')"><spring:message code="fcst.seasonal_prediction.vars.ssp"/></button>
                <button class="btn btn-info btn-sm btn-modal-seaAreaTs" id="btn-modal-seaAreaTs-t15m" onclick="changeTimeSeries('t15m')"><spring:message code="fcst.seasonal_prediction.vars.tmp.m15"/></button>
                <button class="btn btn-info btn-sm btn-modal-seaAreaTs" id="btn-modal-seaAreaTs-tsfc" onclick="changeTimeSeries('tsfc')"><spring:message code="fcst.seasonal_prediction.vars.tmp.ground"/></button>
                <button class="btn btn-info btn-sm btn-modal-seaAreaTs" id="btn-modal-seaAreaTs-wind" onclick="changeTimeSeries('wind')"><spring:message code="fcst.seasonal_prediction.vars.wind"/></button>
            </div>
