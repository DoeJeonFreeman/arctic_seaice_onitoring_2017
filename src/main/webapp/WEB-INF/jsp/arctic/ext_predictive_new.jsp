...
<head>
    ...
    $(document).ready(function() {
        ...
        var path_img = "<c:url value='/data/IMG/FCST/'/>" + "seaice_pre_ext_ano_${mostRecentStuff.lateststuff}.png";
    ...
    function changeImgSrc(dateStr) {
        //alert(dateStr);
        var path = "<c:url value='/data/IMG/FCST/'/>" + "seaice_pre_ext_ano_"+dateStr+".png";
    ...
    function moveLeadtime(imgIdx, leadTime) {
        ...
        var pathExt = "<c:url value='/data/IMG/FCST/'/>" + nameExt;   //seaice_pre_ext_201604_00.png
        var pathAno = "<c:url value='/data/IMG/FCST/'/>" + nameAno;   //seaice_pre_ano_201604_00.png
...
<body id="fabulousbdtc">
            ...
            <div class="row form-horizontal">
                ...
                <div class="vcenter">
                    ...
                    <div id="retrievalRangeSelector" class="dropdown select pull-left" style="margin-left: 3px;margin-right: 3px">
                        <button class="  btn-small dropdown-toggle " type="button" id="menu1" data-toggle="dropdown" style="margin-top:6px;">
                            <span class="selected" id="2" value="MONTH"><spring:message code="dropdown.seeking.interval.monthly"/></span><span class="caret"></span>
                        </button>
                ...
                <div class="pull-right" style="padding-right:50px;"> 
                    <ul id="breadcrumbs-one" class="pull-right vcenter" >
                        ...
                        <li><a><spring:message code="nav.prediction.fcst"/></a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container" >
        <div class="col-lg-12">
            <h2 class="page-header" style="color: #0b56a8;"><spring:message code="fcst.forecast.title"/></h2>
        </div>
        <div align="center">
            <div class="row">
                <p class="col-lg-12">
                ...
                <div class="col-md-12">
                    <div class="hbox">
                        ...
                        <p>※ <spring:message code="fcst.forecast.updated.on"/></p>
                    </div>
                </div>
            </div>
        </div>
