...
;(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            $.when(defer).done(function (imgObj) {
            	//console.log('when(defer).done(function()){ start')
    ...
    $.fn[pluginName] = function (options) {
    	//console.log('jquery.fn[pluginName] options are ==');
    	//console.log(options);
        return this.each(function () {
        	//console.log('variable pluginName is [' + pluginName + ']')
        	//console.log($.data(this, 'plugin_' + pluginName));
        	
            //if (!$.data(this, 'plugin_' + pluginName)) {	//comment out by djfreeman 2016.10.05. 
                $.data(this, 'plugin_' + pluginName, new Plugin(this, options)); //overwrite wartermark plugin as same key?
            //}
