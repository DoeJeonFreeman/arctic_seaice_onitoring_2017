...
public interface BoardService {
	...
	//글수정
	@PreAuthorize("#article.userid == principal.username or hasRole('ROLE_ADMIN')")
	...
	//첨부파일 삭제
	@PreAuthorize("#attachFile.userid == principal.username or hasRole('ROLE_ADMIN')")
	...
	//댓글 수정
	@PreAuthorize("#comment.userid == principal.username or hasRole('ROLE_ADMIN')")
